...
void A_1() {
  if (analogRead(A7)== 1007 && flag_1 == false) {
    ...
    flag_1 = true;
    delay(300);                                         //"debounce" delay, um zu verhindern das der encoder zu viele schritte erkennt
  }
...
void A_2() {
  if (analogRead(A8)>150 && flag_2 == false) {
    ...
    flag_2 = true;
    delay(200);                                         //"debounce" delay, um zu verhindern das der encoder zu viele schritte erkennt
  }
...
void A_3() {
  if (analogRead(A9)>400 && flag_3 == false) {
    ...
    flag_3 = true;
    delay(50);                                         //"debounce" delay, um zu verhindern das der encoder zu viele schritte erkennt
  }
